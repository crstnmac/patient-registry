...
router.post("/add-menu",userAuth,checkRole([ROLE.admin]),async (req, res) => {
...
router.put("/update-menu",userAuth,checkRole([ROLE.admin]), async (req, res) => {
  await updateMenu(req, res);
})

router.delete("/delete-menu/:menuId",userAuth,checkRole([ROLE.admin]), async (req, res) => {
